<template>
  <div class="flex justify-center items-center md:h-screen">
    <div class="md:flex justify-center h-auto md:shadow-2xl">
      <div class="relative md:w-1/2 md:pb-0 pb-4/5 overflow-hidden">
        <img
      ...
      <div class="p-7 md:w-1/2">
        <div>
          ...
          <div class="flex items-center text-sm font-dm-sans mt-3">
            <img src="../assets/tag.png" alt="" />
            <p class="ml-1">40,000 NGN/Day</p>
          </div>
          <div class="flex items-center text-sm font-dm-sans mt-3">
            <img src="../assets/rate.png" alt="" />
            <p class="ml-2">4.75 (98 reviews)</p>
          </div>
        </div>
        ...
        <div class="mt-7">
          ...
          <p class="font-dm-sans text-sm mt-2">
        ...
        <div class="mt-10 flex items-center font-dm-sans">
          <button
            class="
